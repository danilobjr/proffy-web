...
let make = (~className="", ~name: iconName, ~onClick={_ => ()}) => {
  switch name {
  | Back =>
    <svg className=append(["icon -back", className]) onClick width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | Book =>
    <svg className=append(["icon -book", className]) width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | CaretDown =>
    <svg className=append(["icon -caret-down", className]) width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 1L5 5L9 1" stroke="#A380F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  | Check =>
    <svg className=append(["icon -check", className]) width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9 1L4.00022 6L1 2.99965" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  | Easel =>
    <svg className=append(["icon -easel", className]) width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | Filter =>
    <svg className=append(["icon filter", className]) width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11.5 10.5L16.707 5.293C16.895 5.105 17 4.851 17 4.586V2C17 1.448 16.552 1 16 1H2C1.448 1 1 1.448 1 2V4.586C1 4.851 1.105 5.106 1.293 5.293L6.5 10.5" stroke="#04D361" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6.5 10.5V16.749C6.5 17.562 7.264 18.159 8.053 17.962L10.553 17.337C11.109 17.198 11.5 16.698 11.5 16.124V10.5" stroke="#04D361" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  | Heart =>
    <svg className=append(["icon -heart", className]) width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | HeartOutline =>
    <svg className=append(["icon -heart-outline", className]) width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | PageIndicator =>
    <svg className=append(["icon -page-indicator", className]) width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="2" cy="2" r="2" fill="#C1BCCC"/>
    </svg>
  | PageIndicatorHighlight =>
    <svg className=append(["icon -page-indicator-highlight", className]) width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="3" cy="3" r="3" fill="#8257E5"/>
    </svg>
  | Power =>
    <svg className=append(["icon -power", className]) width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  | SeePassword =>
    <svg className=append(["icon -see-password", className]) xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
