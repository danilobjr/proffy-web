...
let make = (~className="", ~name: iconName, ~onClick={_ => ()}) => {
  ...
  | Heart =>
    <svg className=append(["icon -heart", className]) width="20" height="18" viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
  ...
  | PageIndicator =>
    <svg className=append(["icon -page-indicator", className]) width="4" height="4" viewBox="0 0 4 4" xmlns="http://www.w3.org/2000/svg">
      <circle cx="2" cy="2" r="2" />
    </svg>
  | PageIndicatorHighlight =>
    <svg className=append(["icon -page-indicator-highlight", className]) width="6" height="6" viewBox="0 0 6 6" xmlns="http://www.w3.org/2000/svg">
  ...
  | Whatsapp =>
    <svg className=append(["icon -whatsapp", className]) width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
